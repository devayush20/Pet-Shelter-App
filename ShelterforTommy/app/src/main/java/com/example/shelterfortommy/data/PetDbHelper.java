...
public class PetDbHelper extends SQLiteOpenHelper {
    ...
    public PetDbHelper(Context context)
    {
        ...
        Log.i("###","entered the PetDbHelper constructor"+count +" context: "+context.toString());
        Log.i("###","Exiting the PetDbHelper() constructor"+count);
    }
    /**
    ...
    public void onCreate(SQLiteDatabase sqLiteDatabase) {
        ...
        Log.i("####","Entered the onCreate() method of the PetDbHelper class");
