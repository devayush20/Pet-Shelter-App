...
import com.example.shelterfortommy.data.PetProvider;
...
public class CatalogActivity extends AppCompatActivity {
    ...
    //Not required when using Content Provider
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //Get the instance of the PetDbHelper class
        //mDbHelper=new PetDbHelper(this);
        //Log.i("###","Obtained the instance of PetDbHelper");

        //Log.i("###","calling displayDatabaseInfo() inside Catalog activity");

        //displayDatabaseInfo();//to check if database is implemented correctly

        Log.i("###","exiting onCreate() inside Catalog activity");
        //For pulling the database file from device
    ...
    private void displayDatabaseInfo()
    {
        ...
        //Log.i("###","Database object obtained after creating/opening inside displayDatabaseInfo()");

        //Perform this raw SQL query "SELCT * FROM pets"
       ...
       /* Cursor cursor=db.query(PetEntry.TABLE_NAME,
                ...
                null,
                null);
                SAMPLE QUERY-NOT A GOOD PRACTICE
        */
